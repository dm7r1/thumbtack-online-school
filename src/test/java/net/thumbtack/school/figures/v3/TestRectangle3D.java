...
public class TestRectangle3D {
    ...
    @Test
    public void isInsidePoint3DRectangle3D() throws ColorException {
        Rectangle3D rect3D = new Rectangle3D(0, 0, 10, 10, 20, Color.RED);
        assertFalse(rect3D.isInside(new Point3D(5, 5, -10)));
        assertFalse(rect3D.isInside(new Point3D(5, 5, 30)));
        assertFalse(rect3D.isInside(new Point3D(-5, 5, 10)));
        assertFalse(rect3D.isInside(new Point3D(5, -5, 10)));
        assertTrue(rect3D.isInside(new Point3D(10, 10, 0)));
        assertFalse(rect3D.isInside(new Point3D(5, 20, 10)));
        assertFalse(rect3D.isInside(new Point3D(300, -300, 10)));
        assertTrue(rect3D.isInside(new Point3D(5, 5, 10)));
        assertTrue(rect3D.isInside(new Point3D(10, 10, 0)));
        assertTrue(rect3D.isInside(new Point3D(10, 10, 20)));
        assertTrue(rect3D.isInside(new Point3D(0, 0, 0)));
        assertTrue(rect3D.isInside(new Point3D(0, 0, 20)));
    }
