...
public class TestRectangle {
    ...
    @Test
    public void setPointsRectangle() throws ColorException {
        Rectangle rect = new Rectangle(Color.RED);
        rect.setBottomRight(new Point2D(50, 70));
        assertEquals(new Point2D(50, 70), rect.getBottomRight());
        rect.setTopLeft(new Point2D(70, 50));
        assertEquals(new Point2D(70, 50), rect.getTopLeft());
    }
}
